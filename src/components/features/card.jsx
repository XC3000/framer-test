  ...
  return (
    <div
      className={classNames(
        "absolute inset-0 h-full w-ful rounded-2xl bg-gradient-to-br transition-opacity",
        gradient,
        inViewFeature === id ? "opacity-100" : "opacity-0"
      )}
    >
      {children}
      <button className="bg-black absolute bottom-6 right-6 rounded-xl px-4 py-2 text-white shadow-lg">
        Show Me
      </button>
    </div>
  );
...
export const Music = ({ id }) => {
  return (
    <FeatureCard id={id} gradient="from-[#f7fff5] to-[#adffd8]">
      <div className="relative left-[10%] top-[10%] w-[20%] h-[20%] rounded-lg shadow-lg">
        <Image src="/features/song-1.webp" alt="song" fill />
      </div>
      <div className="relative left-[70%] top-[20%] w-[25%] h-[20%] rounded-lg shadow-lg">
        <Image src="/features/song-2.webp" alt="song" fill />
      </div>
      <div className="relative left-[10%] top-[20%] w-[30%] h-[30%] rounded-lg shadow-lg">
        <Image src="/features/song-3.webp" alt="song" fill />
      </div>
      <div className="relative left-[45%] bg-[#1bd761] p-3 top-[-50%] w-20 h-48 rounded-[96px] shadow-lg">
